...
const Hero: FC<Props> = (props) => {
    return (
           ...
           <div className="1000px:w-[40%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10">
             <Image
               src={require("../../../public/Assest/banner-img-1.png")}
               alt=""
            ...
            <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
                ...
                <p className="dark:text-[#edfff4] text-[#000000ac] font-Josefin font-[600] text-[18px] 1500px:!w-[55%] 1100px:!w-[78%]">
                    We have 40K+ online courses and 500K+ registered students
                </p>
                <br />
                <br />
                ...
                <div className="1500px:w-[55%] 1100px:w-[78%] w-[90%] flex items-center">
                    <Image
                        src={require("../../../public/Assest/client-1.jpg")}
                        alt=""
                        className="rounded-full"
                    />
                    <Image
                        src={require("../../../public/Assest/client-2.jpg")}
                        alt=""
                        className="rounded-full ml-[-20px]"
                    />
                    <Image
                        src={require("../../../public/Assest/client-3.jpg")}
                        alt=""
                        className="rounded-full ml-[-20px]"
                    />
